...
class TestVectorStore:
    ...
    def test_search_with_broken_max_results_zero(self, broken_config, mock_chroma_collection):
    ...
    def test_search_with_course_filter(self, test_config, mock_chroma_collection):
        ...
        with patch('vector_store.chromadb') as mock_chromadb:
            ...
            mock_client.get_or_create_collection.side_effect = [course_catalog, content_collection]
    ...
    def test_search_with_both_filters(self, test_config):
        ...
        with patch('vector_store.chromadb') as mock_chromadb:
            ...
            content_collection.query.return_value = {
                ...
                'metadatas': [[{"course_title": "Specific Course", "lesson_number": 3}]],
                'distances': [[0.1]]
            }
            ...
            result = vector_store.search("test query", course_name="Specific", lesson_number=3)
    ...
    def test_search_database_error(self, test_config):
        ...
        with patch('vector_store.chromadb') as mock_chromadb:
            ...
            course_catalog = Mock()
            content_collection = Mock()
            content_collection.query.side_effect = Exception("Database connection failed")
    ...
    def test_add_course_content(self, test_config, sample_course_chunks):
        ...
        with patch('vector_store.chromadb') as mock_chromadb:
            ...
            assert call_args[1]['metadatas'][0]['course_title'] == sample_course_chunks[0].course_title
            assert call_args[1]['metadatas'][0]['lesson_number'] == sample_course_chunks[0].lesson_number
