...
class TestCourseSearchTool:
    ...
    def test_execute_with_both_filters(self, mock_vector_store, sample_search_results):
        ...
        # Execute
        result = tool.execute("test query", course_name="Anthropic Course", lesson_number=1)
    ...
    def test_execute_empty_results_with_filters(self, mock_vector_store, empty_search_results):
        ...
        # Execute
        result = tool.execute("test query", course_name="Missing Course", lesson_number=5)
    ...
    def test_format_results_without_lesson_number(self, mock_vector_store):
        ...
        search_results = SearchResults(
            documents=["Test content"],
            metadata=[{"course_title": "Test Course", "chunk_index": 0}],  # No lesson_number
            distances=[0.1]
        )
        mock_vector_store.search.return_value = search_results
    ...
    def test_multiple_documents_formatting(self, mock_vector_store):
        ...
        expected_sources = ["AI Course - Lesson 1", "AI Course - Lesson 2", "ML Course - Lesson 1"]
        expected_links = ["https://example.com/ai1", "https://example.com/ai2", "https://example.com/ml1"]
